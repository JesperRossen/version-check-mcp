...
tools: Read, Write, Edit, Bash, Grep, Glob, WebSearch, mcp__code-review-graph__*
color: orange
# hooks:
#   PostToolUse:
#     - matcher: "Write|Edit"
...
<required_reading>
@/Users/jfro/workspace/fritid/version-check-mcp/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/Users/jfro/workspace/fritid/version-check-mcp/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/jfro/workspace/fritid/version-check-mcp/.claude
                  → checks /Users/jfro/workspace/fritid/version-check-mcp/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/jfro/workspace/fritid/version-check-mcp/.claude/get-shit-done
                  → writes to /Users/jfro/workspace/fritid/version-check-mcp/.claude/get-shit-done/hooks/
...
@/Users/jfro/workspace/fritid/version-check-mcp/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/jfro/workspace/fritid/version-check-mcp/.claude/get-shit-done/references/common-bug-patterns.md
