...
tools: Read, Write, Bash, Grep, Glob, WebSearch, WebFetch, mcp__context7__*, mcp__firecrawl__*, mcp__exa__*, mcp__code-review-graph__*
color: cyan
# hooks:
#   PostToolUse:
#     - matcher: "Write|Edit"
...
@/Users/jfro/workspace/fritid/version-check-mcp/.claude/get-shit-done/references/thinking-models-research.md
...
```bash
node "/Users/jfro/workspace/fritid/version-check-mcp/.claude/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
