...
tools: Read, mcp__code-review-graph__*
color: magenta
---
...
<reference>
@/Users/jfro/workspace/fritid/version-check-mcp/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/jfro/workspace/fritid/version-check-mcp/.claude/get-shit-done/references/user-profiling.md` to load:
