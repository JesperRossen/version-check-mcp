...
The keys live in `.claude/settings.json` (project) or `/Users/jfro/workspace/fritid/version-check-mcp/.claude/settings.json` (global) — **not** in `.planning/config.json`:
