...
```
Agent(
  prompt="Read /Users/jfro/workspace/fritid/version-check-mcp/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/jfro/workspace/fritid/version-check-mcp/.claude/get-shit-done/templates/SECURITY.md`
