...
```bash
INIT=$(node "/Users/jfro/workspace/fritid/version-check-mcp/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/jfro/workspace/fritid/version-check-mcp/.claude/get-shit-done/templates/spec.md.
