...
```markdown
Read /Users/jfro/workspace/fritid/version-check-mcp/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/jfro/workspace/fritid/version-check-mcp/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/jfro/workspace/fritid/version-check-mcp/.claude/agents/gsd-ui-checker.md for instructions.
