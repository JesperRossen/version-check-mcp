...
INSTALL_JS_GLOBAL="/Users/jfro/workspace/fritid/version-check-mcp/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/jfro/workspace/fritid/version-check-mcp/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
