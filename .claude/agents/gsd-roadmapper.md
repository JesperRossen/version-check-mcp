...
tools: Read, Write, Bash, Glob, Grep, mcp__code-review-graph__*
color: purple
# hooks:
#   PostToolUse:
#     - matcher: "Write|Edit"
...
Reference full template: `/Users/jfro/workspace/fritid/version-check-mcp/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/jfro/workspace/fritid/version-check-mcp/.claude/get-shit-done/templates/state.md`.
