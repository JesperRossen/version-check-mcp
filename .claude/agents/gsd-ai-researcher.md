...
tools: Read, Write, Bash, Grep, Glob, WebFetch, WebSearch, mcp__context7__*, mcp__code-review-graph__*
color: "#34D399"
# hooks:
#   PostToolUse:
#     - matcher: "Write|Edit"
...
<required_reading>
Read `/Users/jfro/workspace/fritid/version-check-mcp/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
