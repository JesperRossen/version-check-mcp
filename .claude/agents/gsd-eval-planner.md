...
tools: Read, Write, Bash, Grep, Glob, AskUserQuestion, mcp__code-review-graph__*
color: "#F59E0B"
# hooks:
#   PostToolUse:
#     - matcher: "Write|Edit"
...
<required_reading>
Read `/Users/jfro/workspace/fritid/version-check-mcp/.claude/get-shit-done/references/ai-evals.md` before planning. This is your evaluation framework.
</required_reading>
