...
tools: Read, Write, Bash, Grep, Glob, WebSearch, WebFetch, mcp__context7__*, mcp__code-review-graph__*
color: "#A78BFA"
# hooks:
#   PostToolUse:
#     - matcher: "Write|Edit"
...
<required_reading>
Read `/Users/jfro/workspace/fritid/version-check-mcp/.claude/get-shit-done/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
